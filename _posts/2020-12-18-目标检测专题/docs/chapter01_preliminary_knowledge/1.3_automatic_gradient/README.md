...
<img src="../../../markdown_imgs/chapter01/1.3_automatic_gradient/variable.png">
...
<img src="../../../markdown_imgs/chapter01/1.3_automatic_gradient/tensor.png">
...
<img src="../../../markdown_imgs/chapter01/1.3_automatic_gradient/computational_graph.gif">
...
y_3 = y_1 + y_2 = x^2 + x^3
$$
，当 $x=1$ 时 $\frac {dy_3} {dx}$ 不应该是5吗？事实上，由于 $y_2$ 的定义是被`torch.no_grad():`包裹的，所以与 $y_2$ 有关的梯度是不会回传的，只有与 $y_1$ 有关的梯度才会回传，即 $x^2$ 对 $x$ 的梯度。
