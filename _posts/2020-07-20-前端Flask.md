...
### 3.FLASK配置项
 ...
 https://blog.csdn.net/qq_33961117/article/details/87365526
...
| **PERMANENT_SESSION_LIFETIME**    | 以 [datetime.timedelta](http://docs.python.org/dev/library/datetime.html#datetime.timedelta)对象控制长期会话的生存时间。从 Flask 0.8 开始，也可以用整数来表示秒。 |
