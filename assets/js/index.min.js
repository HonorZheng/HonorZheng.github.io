$(document).ready(function () {
  function e(e, a) {
    ...
    if (o < s) {
      e.css({ width: "auto", height: "100%" }),
        ...
        (n = a.width());
      var r = (t - n) / 2;
      e.css("margin-left", "-" + r + "px");
    } else {
      var c = (s - o) / 2;
      e.css("margin-top", c + "px");
    }
    e.fadeIn();
  }
  function a() {
  ...
  function n(e) {
    (e +=
      "\n\n著作权归作者所有By Sukhoi\n原文: " +
      location.href),
      $(".post-content").on("copy", function (a) {
        (window.clipboardData || a.originalEvent.clipboardData).setData(
          "text/plain",
          e
        ),
          a.preventDefault();
    ...
    $(document).scroll(function () {
      ...
      e > r
        ? (e > 3 * r && s.addClass("headerUp"),
          ...
          c.css({
            background:
              "url(/assets/icons/logo_" + l + ".svg) no-repeat center",
        ...
        : (s.removeClass("headerUp"),
          ...
          i.css("color", "#fff"),
          o.removeClass(a)),
        u > e ? s.addClass("headerDown") : s.removeClass("headerDown"),
        (u = e);
    });
  }
  $(".read-next-item section").each(function () {
    ...
    (function () {
      for (
        ...
        o > 0 && 1 !== o
          ...
          : 1 === o &&
            (n +=
              '<a href="' + t + '" class="page-link page-num">' + o + "</a>");
      n += '<span class="page-link page-num active">' + a + "</span>";
    ...
    (a.prototype.autoComplete = function () {
      ...
      e.length
        ...
        $.getJSON("../../search.json").done(function (a) {
          var t = "";
          for (var n in a) {
            var o = a[n],
              s = o.title,
    ...
    "true" === $("#nm-switch").val() &&
      (function () {
        var e = $("body"),
          a = new Date(),
          t = a.getHours();
        ((t >= 0 && t <= 6) || 23 === t) && e.addClass("night-mode");
      })(),
